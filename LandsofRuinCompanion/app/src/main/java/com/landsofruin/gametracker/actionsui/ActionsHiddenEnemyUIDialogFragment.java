...
public class ActionsHiddenEnemyUIDialogFragment extends Fragment {
    ...
    public static ActionsHiddenEnemyUIDialogFragment newInstance(Action action,
                                                                 CharacterState character) {
        ActionsHiddenEnemyUIDialogFragment f = new ActionsHiddenEnemyUIDialogFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        doneButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                callback.actionPerformPressed(character, selectedTargets.get(0), null);

            }
        });


        List<CharacterState> targets = character.getEnemyTargetsForEffect(((BaseGameActivity) getActivity()).getGame(), CharacterEffect.ID_HIDDEN);
        ...
        ((TextView) v.findViewById(R.id.title)).setText("Select detected enemy to reveal:");
