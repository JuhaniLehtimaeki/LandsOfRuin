...
public class ReadySetupPlayerLobbyTransition implements Transition {


    public ReadySetupPlayerLobbyTransition() {
    }
    ...
    private void trigger(GameState gameState) {
        ...
        phase.setSecondaryPhase(SecondaryPhase.SETUP_SCENARIO_SELECT);
