...
@ObjectiveCName("PlayerReadySetupTeamTransition")
public class PlayerReadySetupTeamTransition implements Transition {
    private String playerIdentifier;
    private boolean isReady;

    public PlayerReadySetupTeamTransition(String playerIdentifier, boolean isReady) {
    ...
    private void trigger(GameState gameState) {
        ...
        if (everyoneReady) {
            ...
            phase.setSecondaryPhase(SecondaryPhase.SETUP_OVERVIEW);
            for (PlayerState player : gameState.getPlayers()) {
