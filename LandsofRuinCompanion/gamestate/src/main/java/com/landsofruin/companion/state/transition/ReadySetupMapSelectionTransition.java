...
public class ReadySetupMapSelectionTransition implements Transition {


    public ReadySetupMapSelectionTransition() {
    }
    ...
    private void trigger(GameState gameState) {
        ...
        phase.setSecondaryPhase(SecondaryPhase.SETUP_TABLE);
