...
@ObjectiveCName("PlayerReadySetupScenarioTransition")
public class PlayerReadySetupScenarioTransition implements Transition {
    private String playerIdentifier;
    private boolean isReady;

    public PlayerReadySetupScenarioTransition(String playerIdentifier, boolean isReady) {
    ...
    private void trigger(GameState gameState) {
        ...
        if (everyoneReady) {
            ...
            phase.setSecondaryPhase(SecondaryPhase.SETUP_MAP_SELECT);
            for (PlayerState player : gameState.getPlayers()) {
